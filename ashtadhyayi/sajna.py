...
def अनुदात्तङित_आत्मनेपदम्_१_३_१२(इत्, णिच्=False):
    if स्वरितञितः_कर्त्रभिप्राये_क्रियाफले_१_३_७२(इत्) or णिचश्च_१_३_७४(णिच्):
        return 'उ.प'

    for इ in इत्:
        if अनुदात्त in इ:
            return True
    return 'आ.प' if 'ङ्' in इत् else 'प.प'
