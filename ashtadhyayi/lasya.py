...
def लिङस्सीयुट्_३_४_१०२(तिङ्_प्रत्ययः, परस्मैपदम्):
    ...
    if सूत्रम्:
        तिङ्_प्रत्ययः = सूत्रम्(तिङ्_प्रत्ययः)

    if परस्मैपदम्:
        return यासुट्_परस्मैपदेषूदात्तो_ङिच्च_३_४_१०३(तिङ्_प्रत्ययः)
    else:
        return आद्यन्तौ_टकितौ_१_१_४६('सीयुट्', तिङ्_प्रत्ययः)
...
def झस्य_रन्_३_४_१०५(तिङ्_प्रत्ययः):
    return तिङ्_प्रत्ययः.replace('झ', 'रन्')


def इटोऽत्_३_४_१०६(तिङ्_प्रत्ययः):
    return तिङ्_प्रत्ययः.replace('इट्', 'अत्')


def सुट्_तिथोः_३_४_१०७(तिङ्_प्रत्ययः):
    तिथोः = 'त' if 'त' in तिङ्_प्रत्ययः else 'थ'
    return तिङ्_प्रत्ययः.replace(तिथोः, आद्यन्तौ_टकितौ_१_१_४६('सुट्', तिथोः))


def झेर्जुस्_३_४_१०८(तिङ्_प्रत्ययः):
    if सिजभ्यस्तविदिभ्यः_च_३_४_१०९(तिङ्_प्रत्ययः):
        return तिङ्_प्रत्ययः.replace('झि', इत्संज्ञाप्रकरणम्('जुस्', उपदेशसंज्ञकः.प्रत्ययः))
    return तिङ्_प्रत्ययः


def सिजभ्यस्तविदिभ्यः_च_३_४_१०९(तिङ्_प्रत्ययः):
    # TODO :
    return False
