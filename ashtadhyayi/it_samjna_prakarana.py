...
def इत्संज्ञाप्रकरणम्(उपदेशः, उपदेशसंज्ञकः=उपदेशसंज्ञकः.प्रत्ययः, विभक्तिः=False):
    ...
    for सूत्रम् in सूत्राणि:
        ...
        # for स्थानी - figure out a better way
        अल् = वर्णाः('अल्')
        if re.search('^[{अल्}]्?$'.format(अल्=अल्), उपदेशः) is not None:
            break
    return उपदेशः
...
def ञित्_वा(लकारः):
    return इत्(लकारः, उपदेशसंज्ञकः.आदेशः)[0] == 'ञ्'


def णित्_वा(लकारः):
    return इत्(लकारः, उपदेशसंज्ञकः.आदेशः)[0] == 'ण्'


def कित्_वा(प्रत्ययः):
    return 'क्' in इत्(प्रत्ययः, उपदेशसंज्ञकः.प्रत्ययः)
