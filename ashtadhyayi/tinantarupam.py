...
def सन्धि(पदम्):
    ...
    if आदेशः:
        तिङन्तरूपम् += इत्(आदेशः, उपदेशसंज्ञकः.आदेशः)['उपदेशः']
    else:
        तिङन्तरूपम् += इत्(धातुः.get('धातुः'), उपदेशसंज्ञकः.धातुः)['उपदेशः']

    आगमः = धातुः.get('आगमः')
    if आगमः:
        तिङन्तरूपम् += इत्(आगमः, उपदेशसंज्ञकः.आगमः)['उपदेशः']
    ...
    if विकरणप्रत्ययः['प्रत्ययः']:
        तिङन्तरूपम् += इत्(विकरणप्रत्ययः['प्रत्ययः'], उपदेशसंज्ञकः.प्रत्ययः)['उपदेशः']

    if पदम्.तिङ्_प्रत्ययः['प्रत्ययः']:
        तिङन्तरूपम् += इत्(पदम्.तिङ्_प्रत्ययः['प्रत्ययः'], उपदेशसंज्ञकः.प्रत्ययः, True)['उपदेशः']
