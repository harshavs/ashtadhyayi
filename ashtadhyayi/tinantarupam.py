...
from ashtadhyayi.angasya import सार्वधातुकार्धधातुकयोः_७_३_८४, इदितो_नुम्_धातोः_७_१_५८
...
from ashtadhyayi.it_samjna_prakarana import इत्संज्ञाप्रकरणम्, उपदेशसंज्ञकः, इत्
from ashtadhyayi.sajna import मिदचोऽन्त्यात्परः_१_१_४७
from ashtadhyayi.purvatraasiddham import उपधायां_च_८_२_७८, नश्चापदान्तस्य_झलि_८_३_२४
...
def सन्धि(पदम्):
    ...
    if आदेशः:
        तिङन्तरूपम् += इत्संज्ञाप्रकरणम्(आदेशः, उपदेशसंज्ञकः.आदेशः)
    else:
        तिङन्तरूपम् += इत्संज्ञाप्रकरणम्(धातुः.get('धातुः'), उपदेशसंज्ञकः.धातुः)

    आगमः = धातुः.get('आगमः')
    if आगमः:
        तिङन्तरूपम् += इत्संज्ञाप्रकरणम्(आगमः, उपदेशसंज्ञकः.आगमः)
    ...
    if विकरणप्रत्ययः['प्रत्ययः']:
        तिङन्तरूपम् += इत्संज्ञाप्रकरणम्(विकरणप्रत्ययः['प्रत्ययः'], उपदेशसंज्ञकः.प्रत्ययः)

    if पदम्.तिङ्_प्रत्ययः['प्रत्ययः']:
        तिङन्तरूपम् += इत्संज्ञाप्रकरणम्(पदम्.तिङ्_प्रत्ययः['प्रत्ययः'], उपदेशसंज्ञकः.प्रत्ययः, True)

    पदम्.तिङन्तरूपम् = तिङन्तरूपम्
