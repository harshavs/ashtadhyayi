...
def सत्यापपाशरूपवीणातूलश्लोकसेनालोमत्वचवर्मवर्णचूर्णचुरादिभ्यो_णिच्_३_१_२५(गणः):
    # TODO complete
    return गणः == 'चुरादिः'
...
def सिब्बहुलं_लेटि_३_१_३४(पदम्):
    पदम्.विकरणप्रत्ययः['प्रत्ययः'] = 'सिप्'
...
def च्लि_लुङि_३_१_४३(पदम्):
    if पदम्.लकारः == 'लुङ्':
        पदम्.विकरणप्रत्ययः['प्रत्ययः'] = 'च्लि'
    च्लेः_सिच्_३_१_४४(पदम्)
    अस्यतिवक्तिख्यातिभ्योऽङ्_३_१_५२(पदम्)


def च्लेः_सिच्_३_१_४४(पदम्):
    if पदम्.विकरणप्रत्ययः['प्रत्ययः'] == 'च्लि':
        पदम्.विकरणप्रत्ययः['प्रत्ययः'] = 'सिच्'
        शल_इगुपधादनिटः_क्सः_३_१_४५(पदम्)
        if not न_दृशः_३_१_४७(पदम्):
            श्लिष_आलिङ्गने_३_१_४६(पदम्)
        णिश्रिद्रुस्रुभ्यः_कर्तरि_चङ्_३_१_४८(पदम्)
...
def शल_इगुपधादनिटः_क्सः_३_१_४५(पदम्):
    ...
    शल् = वर्णाः('शल्')
    # TODO अनिट्
    if अलोऽन्त्यात्_पूर्व_उपधा_१_१_६५(पदम्.धातुः) in इक् and पदम्.धातुः[-2] in शल्:
...
def णिश्रिद्रुस्रुभ्यः_कर्तरि_चङ्_३_१_४८(पदम्):
    ...
    विभाषा_धेट्श्व्योः_३_१_४९(पदम्)
    if नोनयतिध्वनयत्येलयत्यर्दयतिभ्यः_३_१_५१(पदम्):
        गुपेश्छन्दसि_३_१_५०(पदम्)
...
def गुपेश्छन्दसि_३_१_५०(पदम्):
    # TODO छन्दसि
    if पदम्.धातुः['धातुः'] == 'गुप्' and not नोनयतिध्वनयत्येलयत्यर्दयतिभ्यः_३_१_५१(पदम्):
        पदम्.विकरणप्रत्ययः['प्रत्ययः'] = [पदम्.विकरणप्रत्ययः['प्रत्ययः'], 'चङ्']


def नोनयतिध्वनयत्येलयत्यर्दयतिभ्यः_३_१_५१(पदम्):
    return पदम्.धातुः not in ['ऊन', 'ध्वन', 'इल', 'अर्द']


def अस्यतिवक्तिख्यातिभ्योऽङ्_३_१_५२(पदम्):
    if पदम्.धातुः in ['असुँ', 'वच्', 'ख्या']:
        पदम्.विकरणप्रत्ययः['प्रत्ययः'] = 'अङ्'
    लिपिसिचिह्वश्च_३_१_५३(पदम्)
    पुषादिद्युताद्यॢदितः_परस्मैपदेषु_३_१_५५(पदम्)
    कृमृदृरुहिभ्यश्छन्दसि_३_१_५९(पदम्)
...
def पुषादिद्युताद्यॢदितः_परस्मैपदेषु_३_१_५५(पदम्):
    if पदम्.परस्मैपदम्:
        इत् = पदम्.धातुः['इत्'][0] if पदम्.धातुः['इत्'] else None
        if पदम्.धातुः['गणः'] in ['पुषादि', 'द्युतादि'] or इत् == 'ऌ':
            पदम्.विकरणप्रत्ययः['प्रत्ययः'] = 'अङ्'
        सर्त्तिशास्त्यर्तिभ्यश्च_३_१_५६(पदम्)
        इरितो_वा_३_१_५७(पदम्)


def सर्त्तिशास्त्यर्तिभ्यश्च_३_१_५६(पदम्):
    if पदम्.धातुः in ['सृ', 'शास्', 'ऋ']:
        पदम्.विकरणप्रत्ययः['प्रत्ययः'] = 'अङ्'


def इरितो_वा_३_१_५७(पदम्):
    प्रथमम् = (पदम्.धातुः['इत्'][0] if पदम्.धातुः['इत्'] else None) == 'इर्'
    द्वितीयम् = जॄस्तम्भुम्रुचुम्लुचुग्रुचुग्लुचुग्लुञ्चुश्विभ्यश्च_३_१_५८(पदम्)
    तृतीयम् = कृमृदृरुहिभ्यश्छन्दसि_३_१_५९(पदम्)
    if प्रथमम् or द्वितीयम् or तृतीयम्:
        पदम्.विकरणप्रत्ययः['प्रत्ययः'] = [पदम्.विकरणप्रत्ययः['प्रत्ययः'], 'अङ्']


def जॄस्तम्भुम्रुचुम्लुचुग्रुचुग्लुचुग्लुञ्चुश्विभ्यश्च_३_१_५८(पदम्):
    return पदम्.धातुः in ['जॄ', 'स्तन्भु', 'म्रुचु', 'म्लुचु', 'ग्रुच्', 'ग्लुच्', 'ग्लुञ्च्', 'टुओश्वि']
...
def सार्वधातुके_यक्_३_१_६७(पदम्):
    # TODO
    return


def कर्तरि_शप्_३_१_६८(पदम्):
    # TODO kartari? saarvadhatuke?
    if not पदम्.विकरणप्रत्ययः['प्रत्ययः']:
        पदम्.विकरणप्रत्ययः['प्रत्ययः'] = 'शप्'
