...
def एकाचो_द्वे_प्रथमस्य_६_१_१(पदम्):
    ...
    तुजादीनां_दीर्घोऽभ्यासस्य_६_१_७(पदम्)

    if लिटि_धातोरनभ्यासस्य_६_१_८(पदम्):
...
def लिटि_धातोरनभ्यासस्य_६_१_८(पदम्):
    if not पदम्.धातुः.get('अभ्यस्तम्'):
        return पदम्.लकारः == लकारः.लिट् or सन्यङोः_६_१_९(पदम्) or श्लौ_६_१_१०(पदम्) or चङि_६_१_११(पदम्)


def सन्यङोः_६_१_९(पदम्):
    return पदम्.कृत्प्रत्ययः['प्रत्ययः'] in ['सन्', 'यङ्']


def श्लौ_६_१_१०(पदम्):
    return पदम्.विकरणप्रत्ययः.get('लोपः') == 'श्लु'


def चङि_६_१_११(पदम्):
    return पदम्.विकरणप्रत्ययः.get('प्रत्ययः') == 'चङ्'
